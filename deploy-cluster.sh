...
check_requirements() {
  for cmd in kcli virsh podman make; do
...
kcli delete network ${cluster_name}-sriov -y
...
kcli create network -c 192.168.120.0/24 --dual fd00:192:168:120::/64 ${network_name}
